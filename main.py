...
.select-card {
    ...
    box-shadow: 0px 8px 25px rgba(160, 120, 145, 0.09);
    margin-bottom: 15px;
}
...
.stButton > button {
    ...
    border: none;
    border-radius: 18px;
    background: linear-gradient(90deg, #f7b7c8, #d9c4f7);
    color: white;
    font-size: 17px;
    font-weight: 700;
    box-shadow: 0px 7px 18px rgba(211, 158, 185, 0.25);
    transition: 0.2s;
}
...
travel_data = {
    ...
    "INTJ": {
        ...
        "tip":
            "쇤브룬 궁전과 미술사 박물관을 둘러본 뒤 조용한 카페에서 하루를 마무리해 보세요."
    },
    ...
    "INTP": {
        ...
        "tip":
            "자연사박물관이나 과학박물관처럼 흥미로운 장소를 중심으로 자유롭게 동선을 짜보세요."
    },
    ...
    "ENTJ": {
        ...
        "description":
            "목표가 뚜렷하고 에너지가 넘치는 ENTJ에게는 빠르게 움직이는 뉴욕이 잘 어울려요. "
            "문화·예술·비즈니스·쇼핑까지 다양한 경험을 한 번에 즐길 수 있어요.",
        "tip":
            "맨해튼의 대표 명소들을 테마별로 묶어 효율적인 여행 코스를 만들어 보세요."
    },
    ...
    "ENTP": {
        ...
        "description":
            "새롭고 독특한 경험을 좋아하는 ENTP에게 바르셀로나의 자유로운 분위기를 추천해요. "
            "개성 강한 건축과 활기찬 거리 곳곳에서 예상하지 못한 재미를 발견할 수 있어요.",
        "tip":
            "유명 관광지만 보기보다 골목길과 현지 시장까지 함께 탐방해 보세요."
    },
    ...
    "INFJ": {
        ...
        "description":
            "깊은 감성과 차분한 시간을 중요하게 생각하는 INFJ에게 교토를 추천해요. "
            "고즈넉한 거리와 사찰, 자연 속에서 여유롭게 생각을 정리할 수 있는 여행지예요.",
        "tip":
            "이른 아침 조용한 사찰이나 대나무 숲을 산책하며 한적한 교토를 느껴보세요."
    },
    ...
    "INFP": {
        ...
        "description":
            "상상력이 풍부하고 감성적인 INFP에게는 동화 속 장면 같은 프라하가 잘 어울려요. "
            "오래된 거리와 아름다운 야경을 걷는 것만으로도 특별한 이야기가 만들어져요.",
        "tip":
            "해 질 무렵 카를교를 걸으며 프라하의 야경을 천천히 감상해 보세요."
    },
    ...
    "ENFJ": {
        ...
        "tip":
            "낮에는 자연을 즐기고 저녁에는 함께 여행한 사람들과 여유로운 시간을 보내보세요."
    },
    ...
    "ENFP": {
        ...
        "description":
            "호기심과 에너지가 가득한 ENFP에게는 매 순간 새로운 경험이 기다리는 방콕을 추천해요. "
            "먹거리부터 시장, 야경까지 즉흥적으로 즐길 거리가 가득해요.",
        "tip":
            "세세한 계획을 모두 정하기보다 하루 정도는 마음 가는 대로 움직여 보세요."
    },
    ...
    "ISTJ": {
        ...
        "description":
            "체계적이고 안정적인 여행을 선호하는 ISTJ에게 뮌헨을 추천해요. "
            "정돈된 도시와 역사적인 건축물을 계획적으로 둘러보기 좋아요.",
        "tip":
            "방문 장소와 이동 경로를 미리 정리하면 더욱 만족스러운 여행이 될 거예요."
    },
    ...
    "ISFJ": {
        ...
        "description":
            "따뜻하고 편안한 분위기를 좋아하는 ISFJ에게 코펜하겐을 추천해요. "
            "아기자기한 거리와 여유로운 일상 속에서 편안한 여행을 즐길 수 있어요.",
        "tip":
            "예쁜 카페와 작은 상점을 천천히 둘러보는 여유로운 일정이 잘 어울려요."
    },
    ...
    "ESTJ": {
        ...
        "description":
            "효율적인 일정과 다양한 경험을 좋아하는 ESTJ에게 도쿄를 추천해요. "
            "교통이 편리하고 각 지역의 분위기가 달라 계획적인 도시 여행을 즐기기 좋아요.",
        "tip":
            "지역별로 일정을 묶어 이동 시간을 줄이는 방식으로 여행 계획을 세워보세요."
    },
    ...
    "ESFJ": {
        ...
        "tip":
            "친구와 예쁜 사진을 남기고 현지 디저트와 카페를 함께 즐겨보세요."
    },
    ...
    "ISTP": {
        ...
        "description":
            "직접 몸으로 경험하는 것을 좋아하는 ISTP에게 알프스의 자연을 느낄 수 있는 "
            "인터라켄을 추천해요. 도시 관광보다 활동적인 여행을 즐기기에 좋아요.",
        "tip":
            "자연 경관을 감상할 수 있는 하이킹이나 다양한 야외 체험을 일정에 넣어보세요."
    },
    ...
    "ISFP": {
        ...
        "description":
            "아름다운 풍경과 순간의 감정을 중요하게 생각하는 ISFP에게 제주를 추천해요. "
            "바다와 숲, 감성적인 공간을 천천히 돌아다니며 편안하게 여행할 수 있어요.",
        "tip":
            "일정을 빽빽하게 채우기보다 마음에 드는 장소에서 충분히 머물러 보세요."
    },
    ...
    "ESTP": {
        ...
        "description":
            "활동적이고 새로운 경험을 즐기는 ESTP에게 시드니를 추천해요. "
            "도시와 바다를 동시에 즐기면서 다양한 체험을 할 수 있어 지루할 틈이 없어요.",
        "tip":
            "도시 관광과 해변 활동을 하루 일정에 함께 넣어 역동적으로 즐겨보세요."
    },
    ...
    "ESFP": {
        ...
        "description":
            "즐거운 분위기와 특별한 순간을 사랑하는 ESFP에게 발리를 추천해요. "
            "아름다운 자연과 감각적인 공간이 많아 매일 새로운 추억을 만들기 좋아요.",
        "tip":
            "낮에는 자연을 즐기고 저녁에는 멋진 노을을 감상하며 하루를 마무리해 보세요."
    }
}
...
if recommend:
    ...
    if mbti == "선택하기":
        ...
        for keyword in data["keywords"]:
            keyword_html += f'<span class="keyword">#{keyword}</span>'
